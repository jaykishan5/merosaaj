            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 m-auto w-[90vw] max-w-4xl h-fit max-h-[90vh] bg-white rounded-3xl shadow-2xl z-50 overflow-hidden flex flex-col md:flex-row"
                    >
                        <button
                            onClick={onClose}
                        ...
                        {/* Image */}
                        <div className="md:w-1/2 relative min-h-[300px] md:min-h-[500px] bg-muted">
                            <Image
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className="flex-1 bg-primary text-white h-12 rounded-xl font-black text-xs uppercase tracking-[0.2em] transition-transform hover:scale-105"
                                    >
                                        Add to Bag
                                    </button>
                                    <button
                                ...
                                <Link
                                    ...
                                    className="block text-center text-xs font-black uppercase tracking-widest text-primary hover:text-accent transition-colors pt-4"
                                >
                                    View Full Details
                                </Link>
                            </div>
