...
export default function CartPage() {
    ...
    if (items.length === 0) {
        return (
            <div className="min-h-screen bg-background">
                <Navbar />
                <main className="max-w-[1440px] mx-auto px-4 md:px-6 pb-32 pt-24 md:pt-48 text-center">
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="max-w-[1440px] mx-auto px-4 md:px-6 pb-24 pt-24 md:pt-48">
