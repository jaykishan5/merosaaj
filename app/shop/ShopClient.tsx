                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                        <div className="flex items-center gap-4 w-full sm:w-auto order-2 sm:order-1">
                            <select
                                ...
                                className="flex-1 sm:flex-none bg-muted border border-border rounded-full px-4 py-2 text-xs font-bold outline-none focus:ring-2 focus:ring-primary cursor-pointer appearance-none"
                            >
                        ...
                        <div className="relative w-full sm:w-64 order-1 sm:order-2">
                            ...
                            <input
                                type="text"
                                placeholder="Search..."
                                className="pl-10 pr-4 py-2 bg-muted border border-border rounded-full outline-none focus:ring-2 focus:ring-primary w-full text-sm font-medium"
                                value={search}
