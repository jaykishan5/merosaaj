    ...
    return (
        <div className="p-8 lg:p-12">
            ...
            <div className="max-w-5xl">
                <div className="mb-12">
                    <h1 className="text-4xl font-black tracking-tighter uppercase italic">Create New Drop</h1>
                    <p className="text-muted-foreground mt-1">Initialize a new product in your collection.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-12">
                    ...
                    >
                        {loading ? "Synchronizing..." : "Finalize & Launch Product"}
                    </button>
                </form>
            </div>
        </div>
